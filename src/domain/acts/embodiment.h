...
/// Material for World birth; not a living Man.
class Embodiment {
public:
	Embodiment(id::Man man, id::Soul soul, SoulName name, id::Vessel vessel, DeviceToken token);

	id::Man man() const noexcept { return man_; }
