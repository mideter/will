...
public:
    ...
    std::optional<domain::id::God> god_id() const noexcept { return god_id_; }
...
private:
    ...
    void set_god_id(domain::id::God god_id) noexcept { god_id_ = god_id; }
    ...
    std::optional<domain::id::God> god_id_;
