...
target("will-domain")
    ...
    add_files("src/domain/**.mpp", {public = true})
...
target("will-persistence")
    ...
    add_files("src/infra/persistence/**.mpp", {public = true})
...
target("will-server-lib")
    ...
    add_files("src/server/**.mpp", {public = true})
...
target("will-client-lib")
    ...
    add_files("src/client/**.mpp", {public = true})
...
target("will-load-clients")
    ...
    add_files("tools/**.mpp", {public = true})
